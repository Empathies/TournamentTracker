...
namespace TrackerLibrary.DataAccess.TextHelpers
{
    public static class TextConnectorProcessor
    {
        ...
        public static List<MatchupEntryModel> ConverToMatchupEntryModels(this List<string> lines)
        {
        ...
        private static List<MatchupEntryModel> ConvertStringToMatchupEntryModels(string input)
        {
            ...
            output = matchingEntries.ConverToMatchupEntryModels();
        ...
        {
            List<MatchupEntryModel> entries = GlobalConfig.MatchupEntryFile.FullFilePath().LoadFile().ConverToMatchupEntryModels();
